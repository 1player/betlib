...
const SELECTIONS = [
    ...
    new betlib.PlaceSelection({winOdds: 1 + 2/3, placeOddsFraction: '1/5', rule4: .15}),
    // counts as a loss in non-each way because tied for #2
    new betlib.DeadHeatSelection({winOdds: 8, placeOddsFraction: '1/5', rule4: .15,
     placesOffered: 3, tiedPosition: 2, runnersInDeadHeat: 4}),
    new betlib.VoidSelection(),
    new betlib.LoseSelection(),
    new betlib.WinSelection({winOdds: 101, placeOddsFraction: '1/5'}),
    new betlib.WinSelection({winOdds: 2, placeOddsFraction: '1/1', rule4: .20}),
    new betlib.PlaceSelection({winOdds: 1 + 3/2, placeOddsFraction: '1/3'}),
    new betlib.DeadHeatSelection({winOdds: 1 + 2/3, placeOddsFraction: '1/5', rule4: .35,
     placesOffered: 3, tiedPosition: 1, runnersInDeadHeat: 2}),
];
...
const EXPECTED = {
    ...
    canadian: {
        ...
        eachWay: { bets: 6552, totalReturns: 320870.00 },
    },
    heinz: {
    ...
    superHeinz: {
        nonEachWay: { bets: 4320, totalReturns: 249199.60 },
        eachWay: { bets: 8640, totalReturns: 401874.02 },
    },
    goliath: {
        nonEachWay: { bets: 2223, totalReturns: 106997.52 },
        eachWay: { bets: 4446, totalReturns: 197127.50 },
    },
